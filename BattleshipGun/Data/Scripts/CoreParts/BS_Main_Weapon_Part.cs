...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition BS_Main_Weapon => new WeaponDefinition
        {
            ...
            {
                PartName = "MainGun", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
            ...
            Ammos = new[] {
                AmmoType1  // Must list all primary, shrapnel, and pattern ammos.
            },
